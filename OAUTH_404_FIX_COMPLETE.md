...
User clicks "Continue with Google"
  ↓
Backend sends redirect_uri: https://dhruv-ai-fix.preview.emergentagent.com/api/auth/google/callback
  ↓
...
**Changed Lines:**
- Line 156: Removed fallback `'https://dhruv-ai-fix.preview.emergentagent.com'`
...
CORS_ORIGINS="http://localhost:3000,https://dhruv-ai-fix.preview.emergentagent.com,..."
...
CORS_ORIGINS="http://localhost:3000,https://seamless-auth-1.emergent.host,https://seamless-auth-1.preview.emergentagent.com,..."
```
...
```env
# OLD (WRONG - Preview Domain)
REACT_APP_BACKEND_URL=https://seamless-auth-1.preview.emergentagent.com
