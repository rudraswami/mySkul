...
class DhruvAITester:
    def __init__(self, base_url="https://smart-edu-mentor.preview.emergentagent.com/api"):
...
if __name__ == "__main__":
    ...
    print("🎯 Running REVIEW REQUEST FOCUSED tests...")
    success = tester.run_review_request_focused_tests()
    
    if success:
        print("\n🎉 Review request focused tests completed successfully!")
        sys.exit(0)
    else:
        print("\n⚠️  Some review request tests failed. Check the output above.")
        sys.exit(1)