...
def test_sessions_endpoint():
    # Authenticate
    login_url = 'https://eduai-platform-25.preview.emergentagent.com/api/auth/login'
    ...
    create_response = requests.post(
        'https://eduai-platform-25.preview.emergentagent.com/api/auto-notes/start-session',
        json=session_data,
        headers=headers
    )
    ...
    individual_response = requests.get(
        f'https://eduai-platform-25.preview.emergentagent.com/api/auto-notes/{session_id}',
        headers=headers
    )
    ...
    sessions_response = requests.get(
        'https://eduai-platform-25.preview.emergentagent.com/api/auto-notes/sessions',
        headers=headers
    )
    ...
    analytics_response = requests.get(
        'https://eduai-platform-25.preview.emergentagent.com/api/auto-notes/analytics',
        headers=headers
    )
    ...
    class_series_response = requests.get(
        'https://eduai-platform-25.preview.emergentagent.com/api/auto-notes/class-series',
        headers=headers
    )
