...
const CACHE_NAME = 'dhruv-ai-auto-notes-v8';
const AUDIO_CACHE_NAME = 'dhruv-ai-audio-cache-v8';
// API_CACHE_NAME removed - APIs are NEVER cached (always bypass to network)
