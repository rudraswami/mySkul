...
const CACHE_NAME = 'dhruv-ai-auto-notes-v6';
const AUDIO_CACHE_NAME = 'dhruv-ai-audio-cache-v6';
const API_CACHE_NAME = 'dhruv-ai-api-cache-v6-NEVER-USE'; // Marking as NEVER-USE since we bypass all API caching
