...
const CACHE_NAME = 'dhruv-ai-auto-notes-v7';
const AUDIO_CACHE_NAME = 'dhruv-ai-audio-cache-v7';
const API_CACHE_NAME = 'dhruv-ai-api-cache-v7-NEVER-USE'; // Marking as NEVER-USE since we bypass all API caching
