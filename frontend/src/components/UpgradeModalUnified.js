 ...
 * Can be used both as standalone component (legacy) and via modal context (new)
 */
 ...
 * Renders as AnimatePresence modal (old way)
 */
const UpgradeModal = ({ 
  isOpen, 
  onClose, 
...
/**
 * Hook to open upgrade modal via global modal context (new way)
 */
export const useUpgradeModal = () => {
  ...
  return ({
    ...
    openModal({
      title: limitReached ? "Limit Reached!" : "You're Doing Great!",
      content: (
        <UpgradeModalContent
          upgradeHint={upgradeHint}
          accessInfo={accessInfo}
