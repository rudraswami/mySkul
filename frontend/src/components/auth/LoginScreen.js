    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gray-50">
        <div className="w-full max-w-md">
          ...
          {/* Loading State */}
          {loading && (
            <div className="mb-6 p-6 glass-card rounded-xl text-center fade-in">
          ...
          {/* Gmail Login Card */}
          <div className="glass-card rounded-2xl p-8 shadow-xl fade-in-delay-1">
            <button
              onClick={handleGoogleLogin}
              disabled={loading}
              className="w-full btn-google py-4 px-6 rounded-xl font-semibold text-gray-700 flex items-center justify-center space-x-3 disabled:opacity-50 disabled:cursor-not-allowed"
            >
