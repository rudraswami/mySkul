        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 prose prose-blue dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Welcome to Dhruv AI ("we," "our," or "us"). We are committed to protecting your personal information and your right to privacy. 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Dhruv AI is designed for students aged 13 and above. We do not knowingly collect information from children under 13. 
