        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 prose prose-blue dark:prose-invert max-w-none">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-0">
                  <strong>Dhruv AI is a fully digital educational platform.</strong> We provide AI-powered tutoring, 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              All Dhruv AI services are delivered digitally via the internet:
            </p>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
              ...
              <li><strong>Active Account:</strong> Registered Dhruv AI account with valid subscription</li>
          ...
          <section className="mb-8">
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg border border-yellow-200 dark:border-yellow-800">
              <p className="text-gray-700 dark:text-gray-300 mb-3">
                <strong>Important Clarification:</strong> Dhruv AI does NOT provide:
              </p>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-0">
