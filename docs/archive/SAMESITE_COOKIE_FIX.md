...
**Environment:**
- Frontend: `https://ai-platform-fix-2.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://ai-platform-fix-2.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://ai-platform-fix-2.preview.emergentagent.com
   ```
...
```
1. User visits: https://ai-platform-fix-2.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://ai-platform-fix-2.preview.emergentagent.com/profile-setup
   ↓
