...
**Environment:**
- Frontend: `https://dhruv-tutor-app.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://dhruv-tutor-app.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://dhruv-tutor-app.preview.emergentagent.com
   ```
...
```
1. User visits: https://dhruv-tutor-app.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://dhruv-tutor-app.preview.emergentagent.com/profile-setup
   ↓
