...
**Environment:**
- Frontend: `https://eduai-platform-28.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://eduai-platform-28.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://eduai-platform-28.preview.emergentagent.com
   ```
...
```
1. User visits: https://eduai-platform-28.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://eduai-platform-28.preview.emergentagent.com/profile-setup
   ↓
