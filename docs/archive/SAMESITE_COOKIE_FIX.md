...
**Environment:**
- Frontend: `https://edtech-fixes.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://edtech-fixes.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://edtech-fixes.preview.emergentagent.com
   ```
...
```
1. User visits: https://edtech-fixes.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://edtech-fixes.preview.emergentagent.com/profile-setup
   ↓
