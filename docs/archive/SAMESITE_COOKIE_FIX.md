...
**Environment:**
- Frontend: `https://platform-rescue.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://platform-rescue.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://platform-rescue.preview.emergentagent.com
   ```
...
```
1. User visits: https://platform-rescue.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://platform-rescue.preview.emergentagent.com/profile-setup
   ↓
