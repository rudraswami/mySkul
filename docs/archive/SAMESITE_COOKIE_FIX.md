...
**Environment:**
- Frontend: `https://dhruv-ai-deploy.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://dhruv-ai-deploy.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://dhruv-ai-deploy.preview.emergentagent.com
   ```
...
```
1. User visits: https://dhruv-ai-deploy.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://dhruv-ai-deploy.preview.emergentagent.com/profile-setup
   ↓
