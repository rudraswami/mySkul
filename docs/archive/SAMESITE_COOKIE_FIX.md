...
**Environment:**
- Frontend: `https://dhruv-frontend-test.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://dhruv-frontend-test.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://dhruv-frontend-test.preview.emergentagent.com
   ```
...
```
1. User visits: https://dhruv-frontend-test.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://dhruv-frontend-test.preview.emergentagent.com/profile-setup
   ↓
