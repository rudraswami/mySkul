...
**Environment:**
- Frontend: `https://eduai-revamp.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://eduai-revamp.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://eduai-revamp.preview.emergentagent.com
   ```
...
```
1. User visits: https://eduai-revamp.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://eduai-revamp.preview.emergentagent.com/profile-setup
   ↓
