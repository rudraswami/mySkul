...
**Environment:**
- Frontend: `https://neuro-tutor-dev.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://neuro-tutor-dev.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://neuro-tutor-dev.preview.emergentagent.com
   ```
...
```
1. User visits: https://neuro-tutor-dev.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://neuro-tutor-dev.preview.emergentagent.com/profile-setup
   ↓
