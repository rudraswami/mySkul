...
**Environment:**
- Frontend: `https://dhruvai-upgrade.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://dhruvai-upgrade.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://dhruvai-upgrade.preview.emergentagent.com
   ```
...
```
1. User visits: https://dhruvai-upgrade.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://dhruvai-upgrade.preview.emergentagent.com/profile-setup
   ↓
