...
**Environment:**
- Frontend: `https://dhruv-learn-assist.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://dhruv-learn-assist.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://dhruv-learn-assist.preview.emergentagent.com
   ```
...
```
1. User visits: https://dhruv-learn-assist.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://dhruv-learn-assist.preview.emergentagent.com/profile-setup
   ↓
