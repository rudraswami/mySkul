...
**Environment:**
- Frontend: `https://tutor-evolution.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://tutor-evolution.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://tutor-evolution.preview.emergentagent.com
   ```
...
```
1. User visits: https://tutor-evolution.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://tutor-evolution.preview.emergentagent.com/profile-setup
   ↓
