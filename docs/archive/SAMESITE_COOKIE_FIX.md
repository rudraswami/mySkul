...
**Environment:**
- Frontend: `https://dhruv-neuro-ai.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://dhruv-neuro-ai.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://dhruv-neuro-ai.preview.emergentagent.com
   ```
...
```
1. User visits: https://dhruv-neuro-ai.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://dhruv-neuro-ai.preview.emergentagent.com/profile-setup
   ↓
