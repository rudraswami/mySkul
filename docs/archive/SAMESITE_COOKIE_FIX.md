...
**Environment:**
- Frontend: `https://razorpay-live.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://razorpay-live.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://razorpay-live.preview.emergentagent.com
   ```
...
```
1. User visits: https://razorpay-live.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://razorpay-live.preview.emergentagent.com/profile-setup
   ↓
