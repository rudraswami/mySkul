...
**Environment:**
- Frontend: `https://gmail-auth-dhruv.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://gmail-auth-dhruv.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://gmail-auth-dhruv.preview.emergentagent.com
   ```
...
```
1. User visits: https://gmail-auth-dhruv.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://gmail-auth-dhruv.preview.emergentagent.com/profile-setup
   ↓
