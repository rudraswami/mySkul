...
**Environment:**
- Frontend: `https://auth-gateway-dhruv.preview.emergentagent.com` (`.emergentagent.com` domain)
...
Location: https://auth-gateway-dhruv.preview.emergentagent.com/profile-setup
```
...
3. **Visit Preview Frontend**
   ```
   https://auth-gateway-dhruv.preview.emergentagent.com
   ```
...
```
1. User visits: https://auth-gateway-dhruv.preview.emergentagent.com
   ↓
...
7. Backend:
   ...
   ↓
8. Backend redirects to: https://auth-gateway-dhruv.preview.emergentagent.com/profile-setup
   ↓
