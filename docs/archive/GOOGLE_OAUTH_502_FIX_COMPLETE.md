...
CORS_ORIGINS="http://localhost:3000,https://dhruv-frontend-test.preview.emergentagent.com,https://dhruv-ai-fix.preview.static.emergentagent.com"
```
...
✅ New user created: ...
🍪 Session cookie set
🔄 Redirecting to: https://dhruv-frontend-test.preview.emergentagent.com/profile-setup
```
