...
CORS_ORIGINS="http://localhost:3000,https://ai-platform-fix-2.preview.emergentagent.com,https://dhruv-ai-fix.preview.static.emergentagent.com"
```
...
✅ New user created: ...
🍪 Session cookie set
🔄 Redirecting to: https://ai-platform-fix-2.preview.emergentagent.com/profile-setup
```
