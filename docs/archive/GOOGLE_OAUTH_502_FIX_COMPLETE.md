...
CORS_ORIGINS="http://localhost:3000,https://eduai-platform-28.preview.emergentagent.com,https://dhruv-ai-fix.preview.static.emergentagent.com"
```
...
✅ New user created: ...
🍪 Session cookie set
🔄 Redirecting to: https://eduai-platform-28.preview.emergentagent.com/profile-setup
```
