...
CORS_ORIGINS="http://localhost:3000,https://dhruv-ai-deploy.preview.emergentagent.com,https://dhruv-ai-fix.preview.static.emergentagent.com"
```
...
✅ New user created: ...
🍪 Session cookie set
🔄 Redirecting to: https://dhruv-ai-deploy.preview.emergentagent.com/profile-setup
```
