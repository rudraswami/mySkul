...
**Issue:**
- Preview frontend: `https://auth-gateway-dhruv.preview.emergentagent.com` (`.emergentagent.com` domain)
...
```
Frontend: https://auth-gateway-dhruv.preview.emergentagent.com
Backend: https://seamless-auth-1.emergent.host
