...
User clicks "Continue with Google"
  ↓
Backend sends redirect_uri: https://platform-rescue.preview.emergentagent.com/api/auth/google/callback
  ↓
...
**Changed Lines:**
- Line 156: Removed fallback `'https://platform-rescue.preview.emergentagent.com'`
...
**Before:**
```python
backend_url = os.getenv('BACKEND_URL', 'https://platform-rescue.preview.emergentagent.com')
```
...
FRONTEND_URL=https://platform-rescue.preview.emergentagent.com
CORS_ORIGINS="http://localhost:3000,https://platform-rescue.preview.emergentagent.com,..."
...
CORS_ORIGINS="http://localhost:3000,https://seamless-auth-1.emergent.host,https://platform-rescue.preview.emergentagent.com,..."
```
...
```env
# OLD (WRONG - Preview Domain)
REACT_APP_BACKEND_URL=https://platform-rescue.preview.emergentagent.com
...
6. You can keep the preview URL as well for testing:
   ```
   https://platform-rescue.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **SAVE**
