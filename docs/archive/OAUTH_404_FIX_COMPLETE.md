...
User clicks "Continue with Google"
  ↓
Backend sends redirect_uri: https://eduai-platform-25.preview.emergentagent.com/api/auth/google/callback
  ↓
...
**Changed Lines:**
- Line 156: Removed fallback `'https://eduai-platform-25.preview.emergentagent.com'`
...
**Before:**
```python
backend_url = os.getenv('BACKEND_URL', 'https://eduai-platform-25.preview.emergentagent.com')
```
...
CORS_ORIGINS="http://localhost:3000,https://eduai-platform-25.preview.emergentagent.com,..."
...
CORS_ORIGINS="http://localhost:3000,https://seamless-auth-1.emergent.host,https://eduai-platform-25.preview.emergentagent.com,..."
```
